...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tasks', function (Blueprint $table) {
            ...
            $table->string('assigned_to')->nullable(); // Assigned to column
            $table->date('due_date')->nullable(); // Due date column
            $table->enum('status', ['to_do', 'in_progress', 'done'])->default('to_do'); // Status column
